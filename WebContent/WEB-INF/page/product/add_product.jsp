...
<s:form action="add_product" namespace="/control/product" enctype="multipart/form-data" method="post">
...
<s:hidden name="typeid"/>
  <table width="98%" border="0" cellspacing="1" cellpadding="3" align="center">
    ...
    <tr bgcolor="f5f5f5"> 
      ...
      <td width="75%"> <input type="text" name="v_type_name" disabled="disabled" size="30"/>
      	<!-- 
	...
	<tr bgcolor="f5f5f5"> 
      ...
      <td width="75%"> <input type="text" name="baseprice" size="10" maxlength="10" onkeypress="javascript:InputLongNumberCheck()"/>欧元 <font color="#FF0000">*</font></td>
    </tr>
	<tr bgcolor="f5f5f5"> 
      <td width="25%"> <div align="right">市场价 ：</div></td>
      <td width="75%"> <input type="text" name="marketprice" size="10" maxlength="10" onkeypress="javascript:InputLongNumberCheck()"/>欧元 <font color="#FF0000">*</font></td>
    </tr>
	<tr bgcolor="f5f5f5"> 
      <td width="25%"> <div align="right">销售价 ：</div></td>
      <td width="75%"> <input type="text" name="sellprice" size="10" maxlength="10" onkeypress="javascript:InputLongNumberCheck()"/>欧元 <font color="#FF0000">*</font></td>
    </tr>
    <tr bgcolor="f5f5f5"> 
	...
	<tr bgcolor="f5f5f5"> 
      ...
      <td width="75%"><textarea name="description" cols="50" rows="10"></textarea></td>
	</tr>
    <tr bgcolor="f5f5f5"> 
