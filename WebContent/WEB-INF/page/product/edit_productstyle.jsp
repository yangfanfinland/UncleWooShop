...
<s:form action="edit_style" namespace="/control/product/style" method="post" enctype="multipart/form-data" onsubmit="return checkfm(this)">
<s:hidden name="productstyleid"/>
  <table width="90%" border="0" cellspacing="2" cellpadding="3" align="center">
    <tr bgcolor="6f8ac4">
    	<td colspan="2"  > 
    		<font color="#FFFFFF">修改产品样式：</font>
        </td>
    </tr>
    <tr bgcolor="f5f5f5"> 
      	<td width="22%" > 
      	...
      	<td width="78%">
      		...
      		<input type="text" name="stylename" size="50" maxlength="40"  value="${name}"/>
	...
	<tr bgcolor="f5f5f5"> 
      	...
      	<td width="78%">
      		 ...
      		 <img src="<%=request.getContextPath() %>${imagepath}" width="100"/>
        </td>
    </tr>
    <tr bgcolor="f5f5f5"> 
