...
<link href="<%=request.getContextPath()%>/css/global/header.css" rel="stylesheet" type="text/css" />
...
<body>
	...
	<table cellSpacing=0 cellPadding=0 width=770 align=center border=0>
		<tbody>
			<tr>
				<td background="<%=request.getContextPath() %>/images/login/login_03.jpg">&nbsp;</td>
			</tr>
		</tbody>
	</table>
	<br />
	<c:if test="${!empty error}">
		<div id="errorinfo">
			<table cellSpacing=1 cellPadding=8 width="600" align="center"
	...
	<s:form action="logUI" method="post" namespace="/center/user/login" onsubmit="javascript:return checkForm()">
						...
						<tr>
							<td width="100%" height="50" valign="top">
								<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
									<tr>
										<td width="3%">
											<img src="<%=request.getContextPath() %>/images/global/loginicon1.gif" width="16" height="15" align="absBottom"/></td>
								...
								<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
									<tr>
										<td width="40%" align="right" class="c5">
											<strong>您的用户账号：</strong>
										</td>
										<td width="27%">
											<input name="username" id="username" type="text" size="20" maxlength="20" /></td>
										<td align="left">&nbsp;</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td width="33%" align="left">
											<a href='<s:url action="findpassword" namespace="/user" includeParams="none"/>' class="ablue" target="_blank">忘记密码了？</a>
										</td>
									</tr>
								</table>
							</td>
								...
								<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
									<tr>
										...
										<td width="8%" align="left" valign="middle">
											<input type="image" name="ImageButton1" src="<%=request.getContextPath() %>/images/global/regloginbutton2.jpg" alt="" border="0" />&nbsp;
										</td>
										<td width="58%" align="left" valign="middle">
											如果你还未注册，<span style="font-size: 14px">
											<a href='<s:url action="regUI" namespace="/center/user/register" includeParams="none" />?directUrl=${param.directUrl }' class="ablue2">请免费注册</a>！</span>
										</td>
									</tr>
								</table>
							</td>
