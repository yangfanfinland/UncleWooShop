...
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/vip.css"
	type="text/css" />
<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/FoshanRen.js"></script>
</head>
	...
	<s:form action="list" namespace="/control/user" method="post">
		...
		<table width="90%" border="0" cellspacing="2" cellpadding="3" align="center">
			...
			<tr bgcolor="f5f5f5">
				...
				<td width="78%">
					<input type="text" name="email" size="50" maxlength="45" />
				</td>
			</tr>
			<tr bgcolor="f5f5f5">
				<td colspan="2">
