...
<link href="<%=request.getContextPath()%>/css/global/reg.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript">
	...
	function checkUsername() {
		...
		viewobj.innerHTML = "Is checking...";
		send_request(function(value) {viewobj.innerHTML = value},
		 '<s:url action="isUserExist" namespace="/center/user/register" includeParams="none"/>?username=' + username, true);
	}
</script>
</head>
...
<body>
	...
	<table cellSpacing=0 cellPadding=0 width=770 align=center border=0>
		<tbody>
			...
			<tr>
				<td height=30><img src="<%=request.getContextPath() %>/images/login/zc.gif" width="128"
					height="31" /></td>
			</tr>
		</tbody>
	</table>
			...
			<tbody>
				<tr>
					<td bgColor="#ffffd5" align="left">
						...
						<font color="#990000"><strong><span class="font14">${error}<BR></span></strong></font>
	...
	<div id="Content">
		<s:form action="reg" namespace="/center/user/register" method="post" onsubmit="javascript:return checkForm()">
			<input type="hidden" name="directUrl" value="${param.directUrl}"/>
					<div id="Main">
						<ul id="FormRegStep1_Account" class="RegForm">
							<li class="Title">以下<span class="STYLE1">均为</span>必填项
							</li>
							...
							<li>
								...
								<div class="input">
									...
									<input type="button" name="check_username" value="检查会员名是否可用" onClick="checkUsername()" onMouseOver="this.style.cursor='pointer';" />
								</div>
								<div class="Info">
							...
							<li>
								...
								<div class="Info">
									<div id="email_info">
										没有电子邮件？推荐使用
										<a href="https://reg.cn.yahoo.com/cnreg/cnreg_first?id=78001" target="_blank">雅虎3.5G免费超大邮箱</a>、
