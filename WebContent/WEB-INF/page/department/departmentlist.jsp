...
<s:form action="list" namespace="/control/department" method="post">
<s:hidden name="page"/>
...
<c:forEach items="${pageView.records}" var="entry">
    <tr>
      ...
      <itcast:permission module="department" privilege="update">
       -->
      <a href='<s:url action="department_editUI" namespace="/control/department" includeParams="none"/>?departmentid=${entry.departmentid}'>
      ...
      <!-- 
       ...
       -->
         <a href='<s:url action="delete_department" namespace="/control/department" includeParams="none"/>?departmentid=${entry.departmentid}'>删除</a>
       <!-- 
       </itcast:permission>
      -->
      </div></td>
      ...
      <td bgcolor="f5f5f5" colspan="4" align="center"><table width="100%" border="0" cellspacing="1" cellpadding="3">
          <tr> 
            <td width="5%"></td>
              ...
              -->
              <input type="button" value="添加部门" class="frm_btn" onClick="javascript:window.location.href='<s:url action="department_addUI" namespace="/control/department" includeParams="none"/>'"> &nbsp;&nbsp;
           	  <!-- 
           	  </itcast:permission>
            -->
            </td>
