...
<s:form action="regEmployee" namespace="/control/employee" enctype="multipart/form-data" method="post" onsubmit="return checkfm(this)">
  <table width="90%" border="0" cellspacing="2" cellpadding="3" align="center">
    <tr bgcolor="6f8ac4">
    	<td colspan="2"  > 
    		<font color="#FFFFFF">添加员工：</font>
    	</td>
    </tr>
    <tr bgcolor="f5f5f5"> 
      	<td width="22%" > 
      		<div align="right">登录账号：</div>
      	</td>
      	<td width="78%"> 
      		<input type="text" name="username" size="32" maxlength="32" onblur="javascript:validateUsernameExsit(this.value)">(账号的长度应大于或等于6,不能用中文)
    ...
    <tr bgcolor="f5f5f5"> 
      	...
      	<td width="78%">
      		<input type="password" name="password" size="32" maxlength="32">(密码的长度应大于或等于6,不能用中文)
        	<font color="#FF0000">*</font>
      	</td>
    </tr>
    <tr bgcolor="f5f5f5"> 
    	<td width="22%" > 
    		<div align="right">再次输入登录密码：</div>
    	</td>
      	<td width="78%"> 
