...
<s:hidden name="username"/>
  <table width="90%" border="0" cellspacing="2" cellpadding="3" align="center">
    ...
    <tr bgcolor="f5f5f5"> 
      	...
      	<input <c:if test="${selectdepartmentid==department.departmentid}">checked</c:if> type="radio" name="departmentid" value="${department.departmentid}">${department.name}	
