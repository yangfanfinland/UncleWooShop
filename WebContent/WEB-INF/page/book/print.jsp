...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#333333">
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr>
        <td colspan="2" align="center"><h1 style="margin:15px auto">Uncle Woo China Town 发货单</h1></td>
      </tr>
      <tr>
      ...
      <table width="100%" border="0" align="center" cellpadding="3" cellspacing="2">
        ...
        <tr>
          ...
          <td width="24%" bgcolor="#FFFFFF">${order.orderContactInfo.buyerName }（${order.orderContactInfo.gender}）</td>
